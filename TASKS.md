# TASKS: opencode_setup — current state
...
- [x] **Port: titus-workflow skill** — `.agents/skills/titus-workflow/SKILL.md` + `templates/` (SPEC/ROADMAP/TASKS) | verified: files exist, CI checks them.
