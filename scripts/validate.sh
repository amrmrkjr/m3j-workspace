...
check_file ".agents/skills/m3j-workflow/SKILL.md"
check_file ".agents/skills/m3j-workflow/templates/SPEC.md"
check_file ".agents/skills/m3j-workflow/templates/ROADMAP.md"
check_file ".agents/skills/m3j-workflow/templates/TASKS.md"
